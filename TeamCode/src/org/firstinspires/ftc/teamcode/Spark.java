    ...
    public void setupHardware(Drivetrain type){
        switch (type) {
            ...
            case MECHANUM:
                ...
                motor1 = hwMap.dcMotor.get("front_left_motor");
                motor2 = hwMap.dcMotor.get("front_right_motor");
                motor3 = hwMap.dcMotor.get("back_left_motor");
                motor4 = hwMap.dcMotor.get("back_right_motor");
